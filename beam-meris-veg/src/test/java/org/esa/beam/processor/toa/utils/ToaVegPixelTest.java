/*
 * $Id: ToaVegPixelTest.java,v 1.2 2005/02/18 14:20:19 meris Exp $
 *
...
public class ToaVegPixelTest extends TestCase {

    private VegGenericPixel _pixel;

    public ToaVegPixelTest(String name) {
        super(name);
    }

    public static Test suite() {
        return new TestSuite(ToaVegPixelTest.class);
    }
