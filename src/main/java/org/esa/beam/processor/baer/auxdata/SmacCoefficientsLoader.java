/*
 * $Id: SmacCoefficientsLoader.java,v 1.3 2006/03/24 08:09:03 meris Exp $
 *
...
public class SmacCoefficientsLoader implements SmacCoefficientsAccess {
...
/****************************************/
   ...
   /**
     ...
     */
    public SmacCoefficientsLoader() {
    }

    /**
     * Loads the aux data file associated to the ground reflectances.
     */
    public void load(String auxFilePath) throws IllegalArgumentException, FileNotFoundException, IOException {
        Guardian.assertNotNull("auxPath", auxFilePath);

        _filePath = auxFilePath;

        File coeffFile = new File(_filePath);
   ...
   /**
     ...
     */
    private void scan(File coeffFile) throws FileNotFoundException, IOException {
    ...
    /**
     * Retrieves the next double precision value from the coefficient file
     */
