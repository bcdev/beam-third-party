package org.esa.beam.processor.toc.ui;
 ...
 * File Templates.
 */
public class TocVegUi extends AbstractProcessorUI implements ParamChangeListener {
    ...
    public Vector<Request> getRequests() throws ProcessorException {
        ...
        request.setType(TocVegConstants.REQUEST_TYPE);
    ...
    public void setDefaultRequests() throws ProcessorException {
        VegRequestElementFactory factory = VegRequestElementFactory.getTocVegInstance();
        Request request = new Request();

        request.setType(TocVegConstants.REQUEST_TYPE);
        request.addInputProduct(createDefaultInputProduct());
        request.addOutputProduct(createDefaultOutputProduct());
        request.addParameter(factory.createParamWithDefaultValueSet(TocVegConstants.BITMASK_PARAM_NAME));
        //request.addParameter(factory.createParamWithDefaultValueSet(TocVegConstants.UNCERTAINTY_PARAM_NAME));
        request.addParameter(factory.createDefaultLogPatternParameter(TocVegConstants.DEFAULT_LOG_PREFIX));
    ...
    private void createParameterGroup() {
        final VegRequestElementFactory factory = VegRequestElementFactory.getTocVegInstance();
        ...
        try {
            ...
            _paramGroup.addParameter(factory.createParamWithDefaultValueSet(TocVegConstants.BITMASK_PARAM_NAME));
            _paramGroup.addParameter(factory.createDefaultLogPatternParameter(TocVegConstants.DEFAULT_LOG_PREFIX));
    ...
    private void createUI() {
        ...
        JLabel outFormatLabel = new JLabel(OUT_FORMAT_LABEL);
        ...
        addParameterToPanel(_panel, TocVegConstants.BITMASK_PARAM_NAME, line, 12, gbc);
    }
    ...
    private void handleInputProductChanged() {
        ...
        final Parameter parameter = _paramGroup.getParameter(TocVegConstants.BITMASK_PARAM_NAME);
    ...
    private void getParameter(Request request) {
        request.addParameter(_paramGroup.getParameter(TocVegConstants.BITMASK_PARAM_NAME));
        ...
        if ((inputFile != null) && inputFile.exists() && inputFile.isFile()) {
            try {
                ...
                if (inProduct != null) {
                    ...
                    Parameter bitmask = _paramGroup.getParameter(TocVegConstants.BITMASK_PARAM_NAME);
    ...
    private void setParameter(Request request) throws ProcessorException {
        ...
        try {
            // bitmask
            newParam = request.getParameter(TocVegConstants.BITMASK_PARAM_NAME);
            if (newParam != null) {
                toUpdate = _paramGroup.getParameter(TocVegConstants.BITMASK_PARAM_NAME);
    ...
    private ProductRef createDefaultInputProduct() {
        Parameter inProdParam = VegRequestElementFactory.getTocVegInstance().createDefaultInputProductParameter();
        ProductRef ref = null;
    ...
    private ProductRef createDefaultOutputProduct() {
        Parameter outProdParam = VegRequestElementFactory.getTocVegInstance().createDefaultOutputProductParameter();
