...
public class ToaVegProcessorTest extends TestCase {

    public ToaVegProcessorTest(String name) {
        super(name);
    }

    public static Test suite() {
        return new TestSuite(ToaVegProcessorTest.class);
    }

    public void testThatAuxdataDirIsReturnedCorrectly() {
        ToaVegProcessor processor = new ToaVegProcessor();
